  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <button className="flex items-center gap-2.5 px-6 py-3.5 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-2xl shadow-slate-200 hover:bg-slate-800 transition-all active:scale-95 group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
             ...
             <div key={claim.id} className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden group hover:border-blue-200 transition-all">
                <div className="p-8">
                   ...
                   <div className="flex flex-col sm:flex-row items-center justify-between gap-5 pt-8 border-t border-slate-50 mt-8">
                      ...
                      <button className="w-full sm:w-auto px-6 py-3 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2">
        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="bg-orange-50 rounded-[32px] border border-orange-100 p-7">
              ...
              <button className="w-full py-3.5 bg-white text-orange-600 rounded-xl border border-orange-200 font-black text-[10px] uppercase tracking-widest hover:bg-orange-100 transition-all active:scale-95">
                 Call Claim Expert
              </button>
           </div>
           ...
           <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm p-7">
              ...
              <button className="w-full mt-8 py-4 bg-slate-50 text-slate-400 rounded-xl font-black text-[9px] uppercase tracking-widest border border-dashed border-slate-200">
                 Upload Documents
              </button>
           </div>
        </div>
