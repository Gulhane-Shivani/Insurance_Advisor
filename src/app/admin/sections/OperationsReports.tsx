      ...
      <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm relative overflow-hidden">
        <div className="max-w-2xl relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button className="px-6 py-3 bg-indigo-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {reportTypes.map((report, i) => (
          <div key={i} className="bg-white p-5 rounded-3xl border border-slate-200 hover:border-indigo-300 transition-all group cursor-pointer shadow-sm">
            ...
            <button className="w-full py-2.5 bg-slate-50 text-slate-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all flex items-center justify-center gap-1.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-[28px] border border-slate-200 p-8 shadow-sm">
           ...
           <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                 ...
                 <div className="flex gap-3">
                    {['XLSX', 'PDF', 'CSV'].map(fmt => (
                      <button key={fmt} className="flex-1 py-2.5 border border-slate-200 rounded-lg text-[10px] font-black text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all">
                        {fmt}
                      </button>
                    ))}
                 </div>
              ...
              <button className="w-full py-3.5 bg-indigo-600 text-white rounded-xl font-bold text-base shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all mt-2">
