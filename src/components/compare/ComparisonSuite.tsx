              ...
              <div key={plan.id} className="bg-white rounded-3xl border border-slate-100 shadow-md hover:shadow-xl hover:border-blue-200 transition-all p-5 flex flex-col gap-5 group relative overflow-hidden">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center gap-1.5 flex-1 max-w-[140px] bg-slate-900 text-white px-4 py-2.5 rounded-xl font-bold text-xs hover:bg-blue-600 transition-colors shadow-md active:scale-95"
                  >
